...
public interface TweetRepository extends JpaRepository<TweetEntity, Long>{
	...
	@Query(value = "Select * FROM tweet_entity WHERE userName = :userName order by created_dt desc limit 200", nativeQuery = true)
	public List<TweetEntity> getAllTweetsByUser(@Param("userName") String userName);
	
	@Query(value = "Select * FROM tweet_entity WHERE tweet_text like :hashText order by created_dt desc limit 200", nativeQuery = true)
	public List<TweetEntity> getAllTweetsByHashTag(@Param("hashText") String hashText);
	
	@Query(value = "Select * FROM tweet_entity WHERE userName = :userName AND tweet_text like :hashText order by created_dt desc limit 200", nativeQuery = true)
	public List<TweetEntity> getAllTweetsByNameAndHashTag(@Param("userName") String userName,@Param("hashText") String tweetText);
	
	@Query(value = "Select * FROM tweet_entity WHERE userName = :userName AND tweet_text like :hashText AND created_dt > :fromDate and created_dt < :toDate order by created_dt desc limit 200", nativeQuery = true)
	...
	@Query(value = "Select * FROM tweet_entity WHERE userName = :userName AND created_dt > :fromDate and created_dt < :toDate order by created_dt desc limit 200", nativeQuery = true)
	...
	@Query(value = "Select * FROM tweet_entity WHERE tweet_text like :hashText AND created_dt > :fromDate and created_dt < :toDate order by created_dt desc limit 200", nativeQuery = true)
	...
	@Query(value = "Select * FROM tweet_entity WHERE created_dt > :fromDate and created_dt < :toDate order by created_dt desc limit 200", nativeQuery = true)
